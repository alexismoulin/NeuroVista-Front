...
export default function ProcessingPage({ setPage }) {
    ...
    const steps = [
        ...
        { key: "subs", completedText: "Extra subcortical segmentations completed", loadingText: "Extra subcortical segmentations in Progress (takes up to 1h)" },
        { key: "json", completedText: "Json files created", loadingText: "Json files in Progress" },
    ];

    const [response, setResponse] = useState({dicom: true, nifti: false, recon: false, subs: false, json: false});
