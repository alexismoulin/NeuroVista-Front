...
export default function Dashboard() {
    ...
    const filterList = ["Whole_thalamus", "Whole_hippocampus"];
    const rawData = selectedData?.data || [];
    // Filter out any object whose name or Structure is contained in filterList
    const regionData = rawData.filter(
        item => !filterList.includes(item.Structure || item.name)
    );
